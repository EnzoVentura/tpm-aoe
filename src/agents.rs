...
pub const AGENTS: &[AgentDef] = &[
    ...
    AgentDef {
        ...
        binary: "ollama",
        aliases: &["ollama run"],
        detection: DetectionMethod::Which("ollama"),
        yolo: Some(YoloMode::AlwaysYolo),
        instruction_flag: None,
        set_default_command: false,
        detect_status: status_detection::detect_ollama_status,
        container_env: &[],
        hook_config: None,
        host_only: false,
    },
...
mod tests {
    ...
    fn test_get_agent_known() {
        ...
        assert_eq!(get_agent("ollama").unwrap().binary, "ollama");
    }
    ...
    fn test_resolve_tool_name() {
        ...
        assert_eq!(resolve_tool_name("ollama run llama3"), Some("ollama"));
        assert_eq!(resolve_tool_name("ollama"), Some("ollama"));
    ...
    fn test_settings_index_roundtrip() {
        ...
        assert_eq!(settings_index_from_name(Some("ollama")), 11);
        ...
        assert_eq!(name_from_settings_index(11), Some("ollama"));
